...
function Navbar() {
  ...
  const SmallPolicyForm = () => {
    return (
      <form
        action=""
        className={`hidden max-sm:fixed max-sm:flex max-sm:flex-col max-sm:w-full max-sm:h-[100vh] max-sm:top-[0%] max-sm:left-[0%] max-sm:bg-[rgb(24,24,24,0.85)] max-sm:z-10 max-sm:form-bg-anim ${policyClass}`}
      >
        <div className="fixed flex flex-col top-[0%] left-[0%] form-bg py-[80px] px-[336px] bg-anim policy-small-adapt">
          <label
            className="text-[32px] text-center mb-11 font-normal max-sm:text-center max-sm:text-white max-sm:text-base max-sm:font-semibold max-sm:relative max-sm:top[21px]"
            htmlFor=""
          >
            Политика в отношении обработки персональных данных
          </label>
          <div className="w-[1240px] h-[671px] bg-[#1E1E1E] rounded-tl-[25px] rounded-bl-[25px] overflow-auto scrollbar scrollbar-thumb-[#535353] scrollbar-track-[#3A3A3A] scrollbar-rounded-[5px] max-sm:max-w-[320px] max-sm:h-full">
            <div className="w-[1177px] h-[621px] p-5 max-sm:w-full max-sm:h-full">
              <span className="text-white text-[16px] font-normal leading-loose">
                Политика в отношении обработки персональных данных
                <br />
                1. Общие положения
